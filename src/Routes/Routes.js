...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            {
                path:'/categories/:id',
                loader:({params})=> fetch(`  https://used-product-market-server-one.vercel.app/categories/${params.id}`),
...

        {
            ...
            children:[
                ...
                },
                {
                    ...
                    loader:()=> fetch(`  https://used-product-market-server-one.vercel.app/products`),
